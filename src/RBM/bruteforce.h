...
public:
    ...
    vec solve(const vec &a, const vec &b, const mat &w, const vec &X, ofstream &myfile, ofstream &myfile2);// int mc=10, int N=1
    vec best_a(std::ofstream &myfile, ofstream &myfile2);
