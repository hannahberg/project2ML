...
files_ = ['imp_N1_d1gam0.500000_H2_dt0.000100.dat', 'imp_N1_d1gam0.500000_H2_dt0.001000.dat', 'imp_N1_d1gam0.500000_H2_dt0.010000.dat', 'imp_N1_d1gam0.500000_H2_dt0.100000.dat', 'imp_N1_d1gam0.500000_H2_dt1.000000.dat']
...
plt.xlabel('GDC')
plt.ylabel('Energy')
plt.legend(['dt = 0.0001','dt = 0.001','dt = 0.01','dt = 0.1','dt = 1.0','dt = 2.0'])
plt.show()
